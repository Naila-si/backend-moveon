...
return new class extends Migration
{
    ...
    {
        Schema::create('iwkbu_rows', function (Blueprint $table) {
            ...
            $table->string('outstanding', 7)->nullable();
            $table->string('konfirmasi', 42)->nullable();
            ...
            $table->string('updated_at', 26)->nullable();
        });
    }
    ...
    {
        Schema::dropIfExists('iwkbu_rows');
    }
};
