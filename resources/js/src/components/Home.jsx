                ...
                <section className="center-wrap">
                    <header className="hero">
                        <div className="panel left">
                            <h1 className="title">
                                Selamat datang di{" "}
                                <span className="brand">MOVEON</span>
                            </h1>
                            <p className="subtitle">
                                Sistem digital modern untuk mengelola data
                                dengan cepat, aman, dan interaktif.
                            </p>
                            ...
                            <nav className="cards" aria-label="Fitur utama">
                                ...
                                <Link className="card" to="/manifest">
                                    <div
                                        className="icon bubble ship-ico"
                                        aria-hidden
                                    >
                                        ⛴️
                                    </div>
                  ...
                  <div className="info">
                    ...
                    <p className="card-desc">Lihat & kelola notifikasi terminal</p>
                                ...
                                <Link className="card" to="/notifikasi-berkas">
                                    <div
                                        className="icon bubble bell-ico"
                                        aria-hidden
                                    >
                                        📋
                                    </div>
                                    <div className="info">
                                        ...
                                        <p className="card-desc">
                                            Lihat & kelola notifikasi berkas
                                        </p>
                                    </div>
                                </Link>
                            </nav>
                        ...
                        <div className="panel right">
                            ...
                            <div className="mascot" aria-hidden>
                                ...
                                >
                                    ...
                                    <path
                                        className="road"
                                        d="M18 98 C 48 115, 98 84, 144 96 S 170 110, 170 110"
                                        stroke="#ffd977"
                                        strokeWidth="6"
                                        fill="none"
                                        strokeLinecap="round"
