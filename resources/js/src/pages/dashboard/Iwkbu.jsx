...
export default function Iwkbu() {
    ...
    const [filterPIC, setFilterPIC] = usePersistentState(
        "iwkbu:filter:pic",
        "",
    );
    ...
    const SAMSAT_OPTS = useMemo(() => {
        return Array.from(
            new Set(
                (EMP_OPTS || []).map((e) => e.samsat?.name).filter(Boolean),
            ),
    ...
    const exportToExcel = async () => {
        try {
            const res = await fetch(
                "https://moveon-jr.alwaysdata.net/api/iwkbu-all",
            );
    ...
    const fetchTotalNominal = async () => {
        try {
            const res = await fetch(
                "https://moveon-jr.alwaysdata.net/api/iwkbu-total",
            );
    ...
    const fetchFilterOptions = async () => {
        try {
            const res = await fetch(
                "https://moveon-jr.alwaysdata.net/api/iwkbu-filters",
            );
            const allRows = await res.json();
            ...
            setPicFilterOpts(safeUniq(allRows.map((x) => x.pic)));
    ...
    const fetchRows = async () => {
        ...
        try {
            const res = await fetch(
                `https://moveon-jr.alwaysdata.net/api/iwkbu?page=${page}`,
            );
            const json = await res.json();
    ...
    useEffect(() => {
        if (STATUS_BAYAR_FILTER_OPTS.length)
            setStatusBayarOpts(STATUS_BAYAR_FILTER_OPTS);
    }, [STATUS_BAYAR_FILTER_OPTS]);

    useEffect(() => {
        if (STATUS_KEND_FILTER_OPTS.length)
            setStatusKendaraanOpts(STATUS_KEND_FILTER_OPTS);
    }, [STATUS_KEND_FILTER_OPTS]);

    useEffect(() => {
        if (DOK_PERIZINAN_FILTER_OPTS.length)
            setDokPerizinanOpts(DOK_PERIZINAN_FILTER_OPTS);
    ...
    const saveCell = async (id, field, value) => {
        ...
        const res = await fetch(
            `https://moveon-jr.alwaysdata.net/api/iwkbu/${id}`,
            {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                            ...
                            {pageData.map((r, i) => (
                                <tr key={r.id}>
                                    ...
                                    <td className="sticky nopol-col">
                                        <span className="nopol-badge">
                                            {r.nopol}
                                        </span>
                                    </td>
                                    {/* Aksi */}
                                    <td className="sticky aksi-col">
                                        <button
                        ...
                        >
                            ...
                            <label>
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setF("badanHukum", e.target.value)
                                    }
                                />
                            ...
                            <label>
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setF("tglTransaksi", e.target.value)
                                    }
                                />
                            </label>
                            ...
                            <label>
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setF("masaBerlaku", e.target.value)
                                    }
                                />
                            </label>
                            ...
                            <label>
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setF("masaSwdkllj", e.target.value)
                                    }
                                />
                            </label>
                            ...
                            <label>
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setF("statusBayar", e.target.value)
                                    }
                                />
                            ...
                            <label>
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setF("statusKendaraan", e.target.value)
                                    }
                                />
                            ...
                            <label>
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setF("konfirmasi", e.target.value)
                                    }
                                    placeholder="Catatan"
                                />
                            ...
                            <label>
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setF("dokPerizinan", e.target.value)
                                    }
                                />
                            ...
                            <label>
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setF("tglBayarOs", e.target.value)
                                    }
                                />
                            </label>
                            ...
                            <label>
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setF("tglPemeliharaan", e.target.value)
                                    }
                                />
                            </label>
                        ...
                        <div className="grid">
                            <label>
                                ...
                                <input
                                    ...
                                    value={nominalInput}
                                    onChange={(e) =>
                                        setNominalInput(e.target.value)
                                    }
                                />
                            </label>
                        </div>
